		...
		var
			...
			init = function ($slider, settings, vars) {
				...
				if (settings.controlsPrevNext) {
					...
					buttons = '<a class="' + vars.prefix + 'next ' + vars.prefix + 'btn">' + settings.prevText + '</a><a class="' + vars.prefix + 'prev ' + vars.prefix + 'btn">' + settings.nextText + '</a>';
