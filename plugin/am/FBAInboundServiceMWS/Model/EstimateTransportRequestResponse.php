 ...
 * Generated: Mon Jul 06 15:35:26 GMT 2015
 */
...
/**
 * FBAInboundServiceMWS_Model_EstimateTransportRequestResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>EstimateTransportRequestResult: FBAInboundServiceMWS_Model_EstimateTransportRequestResult</li>
 ...
 */
 ...
 class FBAInboundServiceMWS_Model_EstimateTransportRequestResponse extends FBAInboundServiceMWS_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'EstimateTransportRequestResult' => array('FieldValue' => null, 'FieldType' => 'FBAInboundServiceMWS_Model_EstimateTransportRequestResult'),
     ...
     *
     * @param FBAInboundServiceMWS_Model_EstimateTransportRequestResult estimateTransportRequestResult
    ...
    /**
     * Construct FBAInboundServiceMWS_Model_EstimateTransportRequestResponse from XML string
     * 
     * @param $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FBAInboundServiceMWS_Model_EstimateTransportRequestResponse(($response->item(0))); 
        } else {
