...
/**
 * Update Fulfillment Order Sample
 */
 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as FBAOutboundServiceMWS_Model_UpdateFulfillmentOrder
 $request = new FBAOutboundServiceMWS_Model_UpdateFulfillmentOrderRequest();
...
/**
  ...
  * @param mixed $request FBAOutboundServiceMWS_Model_UpdateFulfillmentOrder or array of parameters
  */
