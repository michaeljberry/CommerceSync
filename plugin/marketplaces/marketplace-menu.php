...
?>
    <div id='sub-nav'>
        <ul id='sub-nav-ul'>
            ...
            <li><i class='fa fa-search fa-fw'></i><a href='#' id='product-search-menu' class='sub-menu'>Product
                    Search</a></li>
            <li><i class='fa fa-refresh fa-fw'></i><a href='#' id='update-inventory-menu' class='sub-menu'>Update
                    Inventory</a></li>
            <li><i class='fa fa-truck fa-fw'></i><a href='#' id='unshipped-orders' class='sub-menu'>Unshipped Orders</a>
            </li>
            <?php
    ...
    <form id='order-lookup-form'>
        ...
        <input type='text' name='order_num' id='order_num' class='forminputround' placeholder='Order Number'
               onclick='this.select();'/><br>
        <label for='tracking_num' class='formlabel'>Tracking Number</label><br>
        <input type='text' name='tracking_num' id='tracking_num' class='forminputround' placeholder='Tracking Number'
               onclick='this.select();'/><br>
        <label for='first_name' class='formlabel'>First Name</label><br>
        <input type='text' name='first_name' id='first_name' class='forminputround' placeholder='First Name'
               onclick='this.select();'/><br>
        <label for='last_name' class='formlabel'>Last Name</label><br>
        <input type='text' name='last_name' id='last_name' class='forminputround' placeholder='Last Name'
               onclick='this.select();'/><br>
        <label for='date' class='formlabel'>Date</label><br>
        <input type='date' name='date' id='date' class='forminputround date' placeholder='Date'
               onclick='this.select();'/>
        <div id='radio'>
            <input type='radio' name='channel' value='amazon' id='amazon'
                   class='formd' <?php echo(!empty($amazon_page) ? " checked='checked' " : ''); ?>/>
            <label for='amazon' class='formlabel'><span></span>Amazon</label>
            <input type='radio' name='channel' value='ebay' id='ebay'
                   class='formd'<?php echo(!empty($ebay_page) ? " checked='checked'" : ''); ?>/>
            <label for='ebay' class='formlabel'><span></span>eBay</label>
            <input type='radio' name='channel' value='bigcommerce' id='bigcommerce'
                   class='formd'<?php echo(!empty($mml_page) ? " checked='checked'" : ''); ?>/>
            <label for='bigcommerce' class='formlabel'><span></span>MML</label>
            <input type='radio' name='channel' value='reverb' id='reverb'
                   class='formd'<?php echo(!empty($reverb_page) ? " checked='checked'" : ''); ?>/>
    ...
    <form id='update-inventory-form' class='floatright'>
        ...
        <input type='text' name='inventory-sku' id='inventory-sku' class='forminputround' placeholder='SKU'
               onclick='this.select();'/>
        <div id='checkboxes'>
